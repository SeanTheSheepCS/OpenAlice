...
TextureBank initializeTextureBank()
{
	...
	addTextureToTextureBank(TEXTURE_BANK_REF_NUMBER_EMPTY_ICON_TEXTURE, "empty_icon.png", &returnValue);
	addTextureToTextureBank(TEXTURE_BANK_REF_NUMBER_MONEY_ICON_TEXTURE, "money_sign_icon.png", &returnValue);
	addTextureToTextureBank(TEXTURE_BANK_REF_NUMBER_TOMATO_ICON_TEXTURE, "tomato_icon.png", &returnValue);
	addTextureToTextureBank(TEXTURE_BANK_REF_NUMBER_CUCUMBER_ICON_TEXTURE, "cucumber_icon.png", &returnValue);
	addTextureToTextureBank(TEXTURE_BANK_REF_NUMBER_CARROT_ICON_TEXTURE, "carrot_icon.png", &returnValue);
	addTextureToTextureBank(TEXTURE_BANK_REF_NUMBER_TOMATO_SEEDS_ICON_TEXTURE, "tomato_seeds_icon.png", &returnValue);
	addTextureToTextureBank(TEXTURE_BANK_REF_NUMBER_CUCUMBER_SEEDS_ICON_TEXTURE, "cucumber_seeds_icon.png", &returnValue);
	addTextureToTextureBank(TEXTURE_BANK_REF_NUMBER_CARROT_SEEDS_ICON_TEXTURE, "carrot_seeds_icon.png", &returnValue);

	addTextureToTextureBank(TEXTURE_BANK_REF_NUMBER_SAVE_WARNING_FRAME_ONE, "saving_warning_frame_one.png", &returnValue);
