...
enum textureBankReferenceNumbers
{
	...
	//DON'T FORGET TO UPDATE THE DEFINE OF TEXTURE_BANK_PLANT_TEXTURE_REFNUM_START AND TEXTURE_BANK_PLANT_REFNUM_END
	...
	TEXTURE_BANK_REF_NUMBER_TOMATO_STAGE_THREE_HARVEST_TWO_TEXTURE = 180,
	TEXTURE_BANK_REF_NUMBER_TOMATO_STAGE_FOUR_HARVEST_TWO_TEXTURE = 181,
	TEXTURE_BANK_REF_NUMBER_TOMATO_STAGE_FIVE_HARVEST_TWO_TEXTURE = 182,
	TEXTURE_BANK_REF_NUMBER_TOMATO_STAGE_SIX_TEXTURE = 183,

	TEXTURE_BANK_REF_NUMBER_CUCUMBER_STAGE_ONE_TEXTURE = 184,
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_STAGE_TWO_TEXTURE = 185,
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_STAGE_THREE_TEXTURE = 186,
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_STAGE_FOUR_TEXTURE = 187,
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_STAGE_FIVE_TEXTURE = 188,
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_STAGE_SIX_TEXTURE = 189,
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_STAGE_SEVEN_TEXTURE = 190,
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_STAGE_EIGHT_HARVEST_ONE_TEXTURE = 191,
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_STAGE_NINE_HARVEST_ONE_TEXTURE = 192,
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_STAGE_TEN_HARVEST_ONE_TEXTURE = 193,
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_STAGE_EIGHT_HARVEST_TWO_TEXTURE = 194,
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_STAGE_NINE_HARVEST_TWO_TEXTURE = 195,
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_STAGE_TEN_HARVEST_TWO_TEXTURE = 196,
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_STAGE_EIGHT_HARVEST_THREE_TEXTURE = 197,
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_STAGE_NINE_HARVEST_THREE_TEXTURE = 198,
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_STAGE_TEN_HARVEST_THREE_TEXTURE = 199,
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_STAGE_ELEVEN_TEXTURE = 200,

	TEXTURE_BANK_REF_NUMBER_CARROTS_STAGE_ONE_TEXTURE = 201,
	TEXTURE_BANK_REF_NUMBER_CARROTS_STAGE_TWO_TEXTURE = 202,
	TEXTURE_BANK_REF_NUMBER_CARROTS_STAGE_THREE_TEXTURE = 203,

	TEXTURE_BANK_REF_NUMBER_TOMATO_SEED_PACKET_TEXTURE = 204,
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_SEED_PACKET_TEXTURE = 205,
	TEXTURE_BANK_REF_NUMBER_CARROT_SEED_PACKET_TEXTURE = 206,

	TEXTURE_BANK_REF_NUMBER_DAY_NIGHT_CIRCLE_TEXTURE = 207,

	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_ZERO_TEXTURE = 208,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_ONE_TEXTURE = 209,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_TWO_TEXTURE = 210,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_THREE_TEXTURE = 211,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_FOUR_TEXTURE = 212,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_FIVE_TEXTURE = 213,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_SIX_TEXTURE = 214,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_SEVEN_TEXTURE = 215,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_EIGHT_TEXTURE = 216,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_NINE_TEXTURE = 217,

	TEXTURE_BANK_REF_NUMBER_DISPLAYS_THE_WORD_DAY_TEXTURE = 218,
	TEXTURE_BANK_REF_NUMBER_MONEY_SIGN_DISPLAY_TEXTURE = 219
};
