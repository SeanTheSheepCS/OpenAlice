...
enum textureBankReferenceNumbers
{
	...
	TEXTURE_BANK_REF_NUMBER_DAY_NIGHT_CIRCLE_TEXTURE = 212,

	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_ZERO_TEXTURE = 213,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_ONE_TEXTURE = 214,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_TWO_TEXTURE = 215,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_THREE_TEXTURE = 216,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_FOUR_TEXTURE = 217,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_FIVE_TEXTURE = 218,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_SIX_TEXTURE = 219,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_SEVEN_TEXTURE = 220,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_EIGHT_TEXTURE = 221,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_NINE_TEXTURE = 222,

	TEXTURE_BANK_REF_NUMBER_DISPLAYS_THE_WORD_DAY_TEXTURE = 223,
	TEXTURE_BANK_REF_NUMBER_MONEY_SIGN_DISPLAY_TEXTURE = 224
};
