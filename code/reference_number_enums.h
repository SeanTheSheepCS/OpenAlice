...
enum textureBankReferenceNumbers
{
    ...
    TEXTURE_BANK_REF_NUMBER_ALICE_RIGHT_WALK_CYCLE_ONE = 14,
    TEXTURE_BANK_REF_NUMBER_ALICE_RIGHT_WALK_CYCLE_TWO = 15,
    TEXTURE_BANK_REF_NUMBER_WORLD_OBJECT_HOE = 16,
    TEXTURE_BANK_REF_NUMBER_WORLD_OBJECT_HOUSE = 17,
    TEXTURE_BANK_REF_NUMBER_WORLD_OBJECT_WELL = 18,
    TEXTURE_BANK_REF_NUMBER_WORLD_OBJECT_WATERING_CAN = 19
};
