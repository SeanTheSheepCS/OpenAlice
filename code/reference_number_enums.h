...
enum textureBankReferenceNumbers
{
	...
	TEXTURE_BANK_REF_NUMBER_TOMATO_STAGE_THREE_TEXTURE = 177,
	TEXTURE_BANK_REF_NUMBER_TOMATO_STAGE_FOUR_TEXTURE = 178,
	TEXTURE_BANK_REF_NUMBER_TOMATO_STAGE_FIVE_TEXTURE = 179,
	TEXTURE_BANK_REF_NUMBER_TOMATO_STAGE_SIX_TEXTURE = 180,
	
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_STAGE_ONE_TEXTURE = 181,
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_STAGE_TWO_TEXTURE = 182,
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_STAGE_THREE_TEXTURE = 183,
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_STAGE_FOUR_TEXTURE = 184,
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_STAGE_FIVE_TEXTURE = 185,
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_STAGE_SIX_TEXTURE = 186,
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_STAGE_SEVEN_TEXTURE = 187,
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_STAGE_EIGHT_TEXTURE = 188,
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_STAGE_NINE_TEXTURE = 189,
	
	TEXTURE_BANK_REF_NUMBER_TOMATO_SEED_PACKET_TEXTURE = 190,
	TEXTURE_BANK_REF_NUMBER_CUCUMBER_SEED_PACKET_TEXTURE = 191,
	TEXTURE_BANK_REF_NUMBER_CARROT_SEED_PACKET_TEXTURE = 192,

	TEXTURE_BANK_REF_NUMBER_DAY_NIGHT_CIRCLE_TEXTURE = 193,

	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_ZERO_TEXTURE = 194,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_ONE_TEXTURE = 195,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_TWO_TEXTURE = 196,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_THREE_TEXTURE = 197,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_FOUR_TEXTURE = 198,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_FIVE_TEXTURE = 199,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_SIX_TEXTURE = 200,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_SEVEN_TEXTURE = 201,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_EIGHT_TEXTURE = 202,
	TEXTURE_BANK_REF_NUMBER_NUMBER_DISPLAY_NINE_TEXTURE = 203,

	TEXTURE_BANK_REF_NUMBER_DISPLAYS_THE_WORD_DAY_TEXTURE = 204,
	TEXTURE_BANK_REF_NUMBER_MONEY_SIGN_DISPLAY_TEXTURE = 205
};
