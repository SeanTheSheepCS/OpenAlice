...
enum TextureBankReferenceNumber
{
	...
	TEXTURE_BANK_REF_NUMBER_SAVE_WARNING_FRAME_ONE = 252,
	TEXTURE_BANK_REF_NUMBER_SAVE_WARNING_FRAME_TWO= 253,
	TEXTURE_BANK_REF_NUMBER_SAVE_WARNING_FRAME_THREE = 254,
	TEXTURE_BANK_REF_NUMBER_SAVE_WARNING_FRAME_FOUR = 255,
	TEXTURE_BANK_REF_NUMBER_CONFIRMATION_SCREEN_BACKGROUND = 256,

	TEXTURE_BANK_REF_NUMBER_LANGUAGE_SCREEN_BACKGROUND_TEXTURE = 257,
	TEXTURE_BANK_REF_NUMBER_ENGLISH_TEXT_TEXTURE = 258,
	TEXTURE_BANK_REF_NUMBER_ENGLISH_ICON_TEXTURE = 259,
	TEXTURE_BANK_REF_NUMBER_FRENCH_TEXT_TEXTURE = 260,
	TEXTURE_BANK_REF_NUMBER_FRENCH_ICON_TEXTURE = 261,
	TEXTURE_BANK_REF_NUMBER_LANGUAGE_BUTTON_ICON = 262,
	
	TEXTURE_BANK_REF_NUMBER_ERROR_MESSAGE_TEXTURE = 263
...
enum AnimationBankReferenceNumber
{
	...
	ANIMATION_BANK_REF_NUMBER_SAVE_WARNING = 52
};
